...
export function EditExpenseDialog({
  ...
  }, [open, initialDescription, initialAmount])
  ...
  const handleSubmit = () => {
    ...
    onEdit(description.trim(), amountNum)
    setDescription("")
    setAmount("")
    setError(null)
    onOpenChange(false)
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>修改支出</DialogTitle>
          <DialogDescription>修改 "{category}" 类别中的支出项</DialogDescription>
        </DialogHeader>
